...
env = simple_spread_v3.parallel_env(N=n_agents, max_cycles=max_episode_steps, continuous_actions=True)
...
policy.retrieval.load_state_dict(torch.load('/home/sangjun/MACFN/retrieval_spread.pkl'))
policy.network.load_state_dict(torch.load('/home/sangjun/MACFN/MACFN_spread.pkl'))
